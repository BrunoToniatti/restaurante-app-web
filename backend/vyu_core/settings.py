"""
Django settings for vyu_core project.
"""
...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-vyu-sprint1-default-key-replace-in-production'
)
...
WSGI_APPLICATION = 'vyu_core.wsgi.application'
ASGI_APPLICATION = 'vyu_core.asgi.application'

# Database Configuration (MySQL as strict default)
...
_cors_origins = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:4200,http://127.0.0.1:3000,http://127.0.0.1:4200')
